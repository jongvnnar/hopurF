...
public class OfflineDataMock implements FlightDataConnection{
    ...
    private OfflineDataMock(){
        ...
        mockSearchFlight = new Flight(1, "TF-OMG", new Airport(2, "KEF", "Keflavik", "keflavik"), new Airport(3, "RVK", "Reykjavik", "keflavik"), LocalDateTime.now(), LocalDateTime.now(),null, 10000);
    }
